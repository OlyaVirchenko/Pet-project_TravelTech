...
Отражает структуру системы: сущности (Trip, PlanItem, PlanOption, Change, User, Notification), их атрибуты и связи.  
Показывает, как данные связаны между собой и какие объекты участвуют в сценариях добавления элементов, голосования и разрешения конфликтов.
...
Отражают поведение системы при ключевых сценариях:  

- Добавление элемента плана (US-02) 

![Sequence_Diagram](screenshots/SequenceDiagram2.png)

---
- Предложение альтернативы (US-03) 

![Sequence_Diagram](screenshots/SequenceDiagram3.png)

---
- Разрешение конфликта изменений (US-05)  

![Sequence_Diagram](screenshots/SequenceDiagram5.png)

Показывают последовательность взаимодействия участников и системы, включая уведомления, сохранение данных и проверку конфликтов.
